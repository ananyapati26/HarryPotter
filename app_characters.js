fetch("https://hp-api.onrender.com/api/characters")
    ...
    .then((objectData) => {
        ...
        charactersWithImages.forEach((values, index) => {
            ...
            cardContent.innerHTML = `
                <img src="${values.image}" alt="${values.name}" class="card-image">
                <p class="card-name">${values.name}</p>
                 <p><strong>Species:</strong> ${values.species}</p>
                <p><strong>Actor:</strong> ${values.actor}</p>
            `;
